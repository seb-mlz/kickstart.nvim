...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      local vue_language_server_path = '/home/smelezan/.local/share/nvim/mason/packages/vue-language-server/node_modules/@vue/language-server/'
      local vue_plugin = {
